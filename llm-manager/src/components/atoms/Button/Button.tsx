...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-secondary-100 hover:bg-secondary-200 text-secondary-900 focus:ring-secondary-500 shadow-soft hover:shadow-medium',
    outline: 'border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 focus:ring-primary-500 hover:border-primary-300 hover:shadow-soft',
    ghost: 'hover:bg-gray-100 text-gray-700 focus:ring-gray-500 hover:shadow-soft',
